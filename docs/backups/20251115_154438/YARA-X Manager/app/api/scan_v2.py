    ...
    try:
        ...
        try:
            ...
            for match in yara_matches:
                    ...
                    for instance in string_match.instances:
                        try:
                            instances_list.append({
                                ...
                                "matched_data": instance.matched_data.decode('utf-8', errors='ignore')[:100] if hasattr(instance, 'matched_data') else ""
                            })
                        except Exception as inst_error:
                            debug_log.append(f"Warning: Failed to process instance: {inst_error}")
                ...
                debug_log.append(f"Processed match: {match.rule}")
